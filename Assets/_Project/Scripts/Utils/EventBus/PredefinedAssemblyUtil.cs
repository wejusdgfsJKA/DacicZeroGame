...
namespace EventBus {
    ...
    /// It allows to get all types in the current AppDomain that implement from a specific Interface id.
    ...
    public static class PredefinedAssemblyUtil {
        ...
        /// <summary>
        /// Gets all Types from all assemblies in the current AppDomain that implement the provided interface id.
        /// </summary>
        /// <param name="interfaceType">Interface id to get all the Types for.</param>
        /// <returns>List of Types implementing the provided interface id.</returns>    
